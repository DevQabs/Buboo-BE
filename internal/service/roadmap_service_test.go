...
func TestProject_PaysDividendsQuarterlyNotMonthly(t *testing.T) {
	...
	a := models.RoadmapAssumptions{
		...
		DividendPlan: []models.DividendHolding{{
			Shares: 100, PerPayment: 2.5, PaymentMonths: []int{3, 6, 9, 12},
			RaiseMonth: 6, BaseYear: 2026, BaseMonth: 9,
		}},
	}
...
func TestSolveRequiredGrowth_FindsTheRateThatHitsTheTarget(t *testing.T) {
	a := models.RoadmapAssumptions{
		...
		DividendPlan: []models.DividendHolding{
			{Symbol: "UNH", Shares: 352, PerPayment: 2.32, PaymentMonths: []int{3, 6, 9, 12},
				RaiseMonth: 6, GrowthRate: 0.109, BaseYear: 2026, BaseMonth: 9},
			{Symbol: "MCD", Shares: 250, PerPayment: 1.86, PaymentMonths: []int{3, 6, 9, 12},
				RaiseMonth: 12, GrowthRate: 0.082, BaseYear: 2026, BaseMonth: 9},
		},
	}
